...
const products = [
  ...
  { name: 'USB-C Hub 7-in-1', description: 'HDMI 4K, USB 3.0, SD card, 100W PD charging. Works with all laptops.', price: 34.99, imageUrl: 'https://images.unsplash.com/photo-1625896064497-a1e3f5b78ee1?w=500', category: 'Electronics', stockQuantity: 60 },
  ...
  { name: 'Leather Bifold Wallet', description: 'Genuine full-grain leather. 8 card slots, 2 note compartments.', price: 29.99, imageUrl: 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=500', category: 'Clothing', stockQuantity: 100 },
